...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("please select the following: 1 to check out books, 2 to check Book Inventory, 3 to exit out");
    ...
    public static void BookInventory(Book[] inventory) {
        Scanner scanner = new Scanner(System.in);
    ...
    public static void CheckoutBooks(Book[] inventory) {
        Scanner scanner = new Scanner(System.in);
        for (Book v : inventory) {
            if (v != null && !v.ischeckedOut()) {
